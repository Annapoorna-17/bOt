...
# ============================================================
# --- /ME ENDPOINTS (MUST BE BEFORE /{user_id} ROUTES) ---
# ============================================================
...
def update_profile(
    ...
    You can update: display_name, email, firstname, lastname, contact_number, address, city, state, country
    """
...
# ============================================================
# --- ADMIN-SPECIFIC USER MANAGEMENT ENDPOINTS (/{user_id}) ---
# ============================================================
...
# ============================================================
# --- END OF ADMIN-SPECIFIC ENDPOINTS ---
# ============================================================
